...
void dados(int pos, int num, int fondo)
{
    int x=3;
    int x1=5;
    int x2=9;
...
void dadosMax(int pos, int num, int fondo2)
{
    int x=36;
    int x1=38;
    int x2=42;
...
void dadosSimulado(int pos, int num, int fondo)
{
    int x=3;
    int x1=5;
    int x2=9;
